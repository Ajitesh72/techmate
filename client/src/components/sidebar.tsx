...
export default function Sidebar() {
  ...
  return (
    ...
    <div className="border-r-2 border-DBDBDB w-72 h-screen pt-12">
      {" "}
      ...
      <div className="mx-2 ">
        ...
        {/* 1st option */}
        <div className="flex gap-10 text-3xl font-semibold my-4 py-2 px-8 rounded-3xl   hover:bg-pink-300 cursor-pointer">
          <svg
        ...
        {/* 2nd option */}
        <div className="flex gap-10 text-3xl font-semibold my-4 py-2 px-8 rounded-3xl   hover:bg-blue-200 cursor-pointer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="1em"
            viewBox="0 0 512 512"
        ...
        {/* 8th option */}
        <div className="flex fixed bottom-0 gap-10 text-3xl font-semibold my-4 py-2 px-8 rounded-3xl  cursor-pointer">
